...
namespace ReadWriteLib 
{
	...
	{
	public:
        static void ReadMemoryOpcodes(HANDLE hProc, uintptr_t moduleBase, std::vector<unsigned int>x32PatchAddress, std::vector<uint8_t>* bbyte)
        {
            uintptr_t val = 0;
        ...
        static void WriteMemoryOpcodes(HANDLE hProc, uintptr_t moduleBase, std::vector<unsigned int>x32PatchAddress, std::vector<unsigned int> x32assemblyOpcodes)
        {
            uintptr_t val = 0;
        ...
        static HANDLE OpenProcessByName(const wchar_t* processName) 
        {
